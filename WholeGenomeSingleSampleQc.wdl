...
# Git URL import
import "https://raw.githubusercontent.com/jasonwalker80/qc-analysis-pipeline/link_inputs_for_multiqc/tasks/Qc.wdl" as QC
...
workflow WholeGenomeSingleSampleQc {
  ...
  # Link the BAM file to a common name for later QC reporting
  call QC.LinkBamFile {
    input:
      input_bam = input_bam,
      base_name = base_name,
  ...
  output {
    ...
    File input_bam_link = LinkBamFile.bam
